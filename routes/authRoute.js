...
Routers.route("/depositemailsend").post(register.depositEmailSend)
Routers.route("/withdrawalemailsend").post(register.withdrawalEmailSend)
Routers.route("/approvedepositemailsend").post(register.ApproveDepositEmailSend)
Routers.route("/confirmwithdrawalemailsend").post(register.ConfirmWithdrawalEmailSend)
